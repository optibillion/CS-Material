...
export default function IssuerDashboard() {
  ...
  async function fetchAll() {
    ...
    const [{ count: myToday }, { count: totalStudents }, { data: salesSum }, { data: recentData }] = await Promise.all([
      ...
      supabase.rpc('get_my_sales_qty', { user_id: profile?.id }),
